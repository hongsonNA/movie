                        ...
                        <div class="slider-nav-2 thumb-ft">
                            <div class="item">
                                <div class="trailer-img">
                                    <img src="{{ asset('images/uploads/trailer7.jpg') }}"  alt="photo by Barn images" width="4096" height="2737">
                                </div>
                            ...
                            <div class="item">
                                <div class="trailer-img">
                                    <img src="{{ asset('images/uploads/trailer2.jpg') }}"  alt="photo by Barn images" width="350" height="200">
                                </div>
                                <div class="trailer-infor">
                            ...
                            <div class="item">
                                <div class="trailer-img">
                                    <img src="{{ asset('images/uploads/trailer6.jpg') }}" alt="photo by Joshua Earle">
                                </div>
                                <div class="trailer-infor">
                            ...
                            <div class="item">
                                <div class="trailer-img">
                                    <img src="{{ asset('images/uploads/trailer3.png') }}" alt="photo by Alexander Dimitrov" width="100" height="56">
                                </div>
                                <div class="trailer-infor">
                            ...
                            <div class="item">
                                <div class="trailer-img">
                                    <img src="{{ asset('images/uploads/trailer4.png') }}"  alt="photo by Wojciech Szaturski" width="100" height="56">
                                </div>
                                <div class="trailer-infor">
                            ...
                            <div class="item">
                                <div class="trailer-img">
                                    <img src="{{ asset('images/uploads/trailer5.jpg') }}"  alt="photo by Wojciech Szaturski" width="360" height="189">
                                </div>
                                <div class="trailer-infor">
